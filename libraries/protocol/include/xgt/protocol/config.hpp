...
//#define XGT_MINING_RECALC_EVERY_N_BLOCKS    uint64_t( 2016 )
#define XGT_MINING_RECALC_EVERY_N_BLOCKS    uint64_t( 10 )
#define XGT_MINING_TARGET_START             "00000ffff0000000000000000000000000000000000000000000000000000000"
